      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-lg border-b border-zinc-100">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3">
          <Link href="/restaurante" className="text-xl font-extrabold tracking-tight">
            ...
            <span className="ml-2 text-xs font-medium text-zinc-400 bg-zinc-100 rounded-full px-2 py-0.5">Parceiro</span>
          </Link>
          <nav className="hidden sm:flex items-center gap-1">
            <NavLink href="/restaurante" icon="📊">Dashboard</NavLink>
            <NavLink href="/restaurante/produtos" icon="📝">Cardápio</NavLink>
            <NavLink href="/restaurante/pedidos" icon="📋">Pedidos</NavLink>
          </nav>
