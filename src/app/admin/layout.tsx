      ...
      <header className="sticky top-0 z-40 glass border-b border-zinc-100/80">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3">
          <Link href="/admin" className="text-xl font-extrabold tracking-tight">
            ...
            <span className="ml-2 text-[11px] font-semibold bg-orange-100 text-orange-700 rounded-full px-2 py-0.5">Admin</span>
          </Link>
          <nav className="hidden sm:flex items-center gap-1">
            ...
            <NavLink href="/admin/entregadores">
            ...
            <NavLink href="/admin/analytics/ab">
